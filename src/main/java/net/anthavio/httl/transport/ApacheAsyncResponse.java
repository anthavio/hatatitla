 ...
 *
 */
public class ApacheAsyncResponse extends HttlResponse {

	private static final long serialVersionUID = 1L;

	private final HttpResponse response;

	public ApacheAsyncResponse(HttlRequest request, int httpCode, String message, Multival<String> headers,
